    ...
    <div class="main clear">
        <div class="nav-bar">
            <ul class="bar1">
                ...
                <li class="bar1-li"><a href="<%=path%>/protal/news">最新开班  <i class="icon-angle-right"></i></a>  </li>
                <li class="bar1-li active"><a href="<%=path%>/protal/news-discount">最新优惠  <i class="icon-angle-right"></i></a>  </li>
            </ul>
            <ul class="bar2">
                ...
                <c:forEach items="${discount}" var="n">
                    <div class="curriculum news-curriculum">
                        ...
                        <div class="clear">
                            ...
                            <img src="static_taige/img/NEWS-dis.png" alt=""/>
                        </div>
                    </div>
                </c:forEach>
