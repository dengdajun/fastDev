...
<div class="content">
    <div class="main clear">
        <div class="nav-bar">
            <ul class="bar1">
                ...
                <li class="bar1-li"><a href="<%=path%>/protal/news-battlefield">最新战报 <i class="icon-angle-right"></i></a> </li>
                <li class="bar1-li active"><a href="<%=path%>/protal/news">最新开班  <i class="icon-angle-right"></i></a>  </li>
                <li class="bar1-li"><a href="<%=path%>/protal/news-discount">最新优惠  <i class="icon-angle-right"></i></a>  </li>
            </ul>
            <ul class="bar2">
                <li class="active bar2-bg1"><a href="tencent://message/?uin=125439857">在线咨询</a></li>
                <li class="bar2-bg2"><a href="<%=path%>/protal/you">免费课申请</a></li>
                <li class="bar2-bg3"><a href="<%=path%>/protal/videos">视频试听</a></li>
            </ul>
        </div>
        <!--右边部分 -->
        <div class="right-con">
                ...
                <c:forEach items="${news}" var="n">
                    <div class="curriculum news-curriculum">
                        ...
                        <div class="clear">
                            ...
                            <img src="static_taige/img/class.png" alt=""/>
                        </div>
                    </div>
                </c:forEach>
    ...
    <script>
        ...
        $.ajax({
        url:"<%=path%>/protal/news_battlefield_id?id=" + nid,
        dataType:"json",
        type:"post",
        scriptCharset: 'utf-8',
        ...
        $.ajax({
        url:"<%=path%>/protal/getNextNews?id=" + nid +"&ntype="+ntype,
        dataType:"json",
        type:"post",
        scriptCharset: 'utf-8',
        success:function(data){
        ...
        $.ajax({
        url:"<%=path%>/protal/getUpNews?id=" + nid +"&ntype="+ntype,
        dataType:"json",
        type:"post",
        scriptCharset: 'utf-8',
        success:function(data){
