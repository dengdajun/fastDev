    ...
    <div class="main clear">
        <div class="nav-bar">
            <ul class="bar1">
                ...
                <li class="active bar1-li"><a href="<%=path%>/protal/videos">思科课程试听 <i class="icon-angle-right"></i></a> </li>
                <li class="bar1-li"><a href="<%=path%>/protal/videos-huawei">华为课程试听  <i class="icon-angle-right"></i></a>  </li>
            </ul>
            <ul class="bar2">
        ...
        <div class="right-con">
            ...
            <div id="article3" class="new-class">
                ...
                <script src="static_taige/js/page-img.js"></script>
                <!-- 必须放这里 -->
            </div>
