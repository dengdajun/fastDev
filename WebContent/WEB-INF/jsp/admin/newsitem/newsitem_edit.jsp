...
<body>
	<form action="newsitem/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<input type="hidden" name="NEWSITEM_ID" id="NEWSITEM_ID" value="${pd.NEWSITEM_ID}"/>
		<textarea name="CONTENT" id="CONTENT" style="display:none" ></textarea>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">新闻名称:</td>
				<td><input type="text" name="TITLE" id="TITLE" value="${pd.TITLE}" maxlength="32" placeholder="这里输入新闻名称" title="新闻名称" width=85%"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">录入时间:</td>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">新闻图片LOGO:</td>
				<td>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">新闻介绍:</td>
				<td>
					<input type="hidden" name="news_desc" id="INTRODUCTION_T"/>
					<textarea  id="INTRODUCTION" placeholder="这里输入新闻介绍" style="width:86%;">${pd.news_desc}</textarea>
				</td>
			</tr>
			<tr>
		...
		<script type="text/javascript" src="static/admin/newsitem/newsitem.js"></script><!-- 日期框 -->
</body>
</html>