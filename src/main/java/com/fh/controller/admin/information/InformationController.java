package com.fh.controller.admin.information;
...
import com.fh.service.admin.information.InformationService;
...
public class InformationController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, "新增Information");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, "修改Information");
	...
	public ModelAndView list(Page page){
		logBefore(logger, "列表Information");
		...
		try{
			...
			mv.setViewName("admin/information/information_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Information页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("admin/information/information_edit");
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改Information页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() {
		logBefore(logger, "批量删除Information");
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Information到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var4", varOList.get(i).getString("REFRESH_TIME"));	//4
