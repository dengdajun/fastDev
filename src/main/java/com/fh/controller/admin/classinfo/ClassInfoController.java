package com.fh.controller.admin.classinfo;
...
import com.fh.service.admin.classinfo.ClassInfoService;
...
public class ClassInfoController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("admin/classinfo/classinfo_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("admin/classinfo/classinfo_edit");
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var2", varOList.get(i).getString("GRADE_TYPE"));	//2
				vpd.put("var3", varOList.get(i).getString("CLASS_DATE"));	//3
				vpd.put("var4", varOList.get(i).get("STUDENT_NUM").toString());	//4
				varList.add(vpd);
			}
